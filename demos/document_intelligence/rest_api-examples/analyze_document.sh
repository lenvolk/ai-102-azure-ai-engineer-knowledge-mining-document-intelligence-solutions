#curl -i -X POST "${AI_SERVICE_ENDPOINT}/documentintelligence/documentModels/{model-id}:analyze?api-version=2024-02-29-preview" \

curl -i -X POST "${AI_SERVICE_ENDPOINT}/documentintelligence/documentModels/prebuilt-receipt:analyze?api-version=2024-02-29-preview" \
